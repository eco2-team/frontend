...
export const AgentInputBar = ({
  ...
  return (
    <div className='max-w-app flex w-full flex-col gap-2 bg-white px-4 pt-3 pb-[max(8px,env(safe-area-inset-bottom,8px))] shadow-[0_-3px_25px_rgba(0,0,0,0.20)]'>
      {/* 숨겨진 갤러리 input */}
      <input
        ref={galleryInputRef}
        type='file'
      ...
      <div className='flex w-full items-end gap-2'>
        ...
        <div className='relative flex flex-col items-center'>
          ...
          <button
            ...
            className='flex w-[100px] items-center justify-center gap-0.5 self-end rounded-md px-1.5 py-0.5 text-[10px] text-gray-500 transition-colors hover:bg-gray-100'
          >
            {selectedModel.label}
            <ChevronUp
